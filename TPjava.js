...
function createRainbowEffect(elementId) {
    ...
    const TARGET6= document.getElementById("reviewHeader");
...
for (var i = 0; i < text6.length; i++) {
  var color = rainbowColors[i % rainbowColors.length];
  rainbowText6 += '<span style="color:' + color + '">' + text6[i] + '</span>';
}
    ...
    TARGET6.innerHTML = rainbowText6;
